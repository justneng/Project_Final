            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="row col-md-12">
                        ...
                        <label for="lname" class="col-md-2 control-label"
                ...
                <div class="form-group">
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-4">
                            <form:input path="thFname" id="fname" name="fname" class="form-control "
                                        onkeypress="return isThai(event)" required="true"/>
                        </div>

                        <label for="lname" class="col-md-2 control-label" style="padding: 7px 0px 7px 0px;">
                            <small>นามสกุล</small>
                            <small style="color: red">*</small>
                        </label>

                        <div class="col-md-4">
                            <form:input path="thLname" id="lname" name="lname" class="form-control"
                                        onkeypress="return isThai(event)" required="true"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row col-md-12">
                        <label for="engfname" class="col-md-2 control-label"
                               style="padding-left: 0px;padding-right: 0px">
                        ...
                        <div class="col-md-4">
                            <form:input path="enFname" id="engfname" name="engfname" class="form-control "
                                        onkeypress="return isEnglish(event)" required="true"/>
                        </div>

                        <label for="englname" class="col-md-2 control-label" style="padding: 7px 0px 7px 0px;">
                            <small>นามสกุล</small>
                            <small style="color: red">*</small>
                        </label>

                        <div class="col-md-4">
                            <form:input path="enLname" id="englname" name="englname" class="form-control"
                                        onkeypress="return isEnglish(event)" required="true"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-4">
                            <form:input path="nickName" id="nickname" name="username" class="form-control"
                                        onkeypress="return isThai(event)" required="true"/>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-10">
                            <div class="col-md-5" style="padding-left: 0px;padding-right: 25px">
                                <div class='input-group date' id='sBirthday'>
                                    <form:input path="birthDate" id="birthday" type='text' class="form-control"
                                                readonly="true"
                            ...
                            <div class="col-md-6">
                                <label class="col-md-4 control-label" style="padding-right: 0px;">
                                    <small>อายุ</small>
                                </label>
                ...
                <div class="form-group">
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-4">
                            <form:select path="compId" id="ddlCom" class="form-control" autocomplete="off"
                                         required="true">
                ...
                <div class="form-group">
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px">
                                <form:select path="teamId" id="team" class="form-control" disabled="true"
                                             required="true">
                                    <%--<option value="">เลือกทีม</option>--%>
                                </form:select>
                                <input class="form-control" id="txbTeam" name="txbTeam" required="true"
                        ...
                        <div class="col-md-10">
                            <div class="col-md-5" style="padding-left: 0px;padding-right: 25px">
                                <div class='input-group date' id='dpStartWork'>
                                    <form:input path="startWork" id="startWork" type='text' class="form-control"
                                                readonly="true"
                                                style="cursor:pointer;background-color:white" required="true"/>
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar"></span>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6" style="padding-right: 0px;padding-left: 23px">
                                    <input id="workeLoad" type="text" class="form-control text-center"
                                           disabled="disabled"/>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-10">
                            <form:textarea path="address" onkeyup="textAreaAdjust(this)" id="address"
                                           class="form-control" required="true" style="resize:none"></form:textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row col-md-12">
                        <label for="stuid" class="col-md-2 control-label" style="padding-left: 0px;padding-right: 0px">
                            <small>มือถือ</small>
                            <small style="color: red">*</small>
                        </label>

                        <div class="col-md-4">
                            <form:input path="tell2" id="telMoblie" class="form-control" maxlength="10"
                                        onkeypress="return isNumber(event)" required="true"/>
                        </div>

                        <label for="stuid" class="col-md-2 control-label" style="padding: 7px 0px 7px 0px;">
                            <small>โทร</small>
                        </label>

                        <div class="col-md-4">
                            <form:input path="tell1" id="telHome" class="form-control " maxlength="10"
                ...
                <div class="form-group">
                    <div class="row col-md-12">
                        ...
                        <label class="col-md-2 control-label" style="text-align: left;">
                            <small>@softsquaregroup.com</small>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row col-md-6 col-md-offset-4">
                        ...
                        <input type="button" class="btn btn-primary pull-left"
                               value="&nbsp;&nbsp;&nbsp;&nbsp;ตกลง&nbsp;&nbsp;&nbsp;&nbsp;" onclick="checkEmpty()"/>

                        <a id="cleardata" class="btn btn-primary pull-left" style="margin-left: 20px"
                           onclick="reloadfunc()">
                            &nbsp;ล้างข้อมูล&nbsp;
                        </a>
                        <a id="cancel" class="btn"
                           style="background-color: rgba(193, 193, 198, 0.83); color: #000000;margin-left: 20px"
                           href=${context}"/TDCS/home.html">
                            &nbsp;&nbsp;&nbsp;&nbsp;ยกเลิก&nbsp;&nbsp;&nbsp;&nbsp;
                        </a>
                    </div>
                </div>
